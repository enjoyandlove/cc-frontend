...
// links
export const getLinksState = createSelector(getManageState, (state: IManageState) => state.links);
export const getLinksRange = createSelector(getLinksState, (state: ILinksState) => state.range);
export const getLinksSort = createSelector(getLinksState, (state: ILinksState) => state.sort);
export const getLinks = createSelector(getLinksState, (state: ILinksState) => state.links);
export const getLinksLoaded = createSelector(getLinksState, (state: ILinksState) => state.loaded);
export const getLinksLoading = createSelector(getLinksState, (state: ILinksState) => state.loading);
