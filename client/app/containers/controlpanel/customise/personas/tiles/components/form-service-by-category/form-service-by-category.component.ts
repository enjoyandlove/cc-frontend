...
@Component({
  selector: 'cp-personas-tile-form-service-by-category',
  templateUrl: './form-service-by-category.component.html',
  styleUrls: ['./form-service-by-category.component.scss']
})
export class PersonasTileFormServiceByCategoryComponent implements OnInit {
