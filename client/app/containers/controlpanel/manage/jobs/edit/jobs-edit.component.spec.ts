    ...
    async(() => {
      TestBed.configureTestingModule({
        ...
        .then(() => {
          ...
          jobSpy = spyOn(component.service, 'editJob')
            .and.returnValue(Observable.of(mockJobs[0]));

          spyFetchJob = spyOn(component.service, 'getJobById')
            .and.returnValue(Observable.of(mockJobs[0]));

          spyEmployer = spyOn(component.employerService, 'createEmployer')
            .and.returnValue(Observable.of(mockEmployers[0]));
        });
    })
  );
