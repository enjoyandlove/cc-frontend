...
export const getMembers = createSelector(getOrientationMemberState, fromMembers.getMembers);

export const getPageNext = createSelector(getOrientationMemberState, fromMembers.getNext);

export const getPagePrevious = createSelector(getOrientationMemberState, fromMembers.getPrevious);

export const getMembersLoading = createSelector(getOrientationMemberState, fromMembers.getLoading);
...
export const getFilters = createSelector(getRouterState, ({ queryParams }) => {
  return {
