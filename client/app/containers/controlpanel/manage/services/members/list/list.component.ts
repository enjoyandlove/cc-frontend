...
@Component({
  selector: 'cp-services-members-list',
  templateUrl: './list.component.html',
  styleUrls: ['./list.component.scss']
})
export class ServicesListMembersComponent extends BaseComponent implements OnInit {
  isEdit = false;
  clubId: number;
  groupId: number;
  isDelete = false;
  ...
  constructor(
    ...
    private serviceUtils: ServicesUtilsService,
  ...
  private fetch() {
    ...
    const groupSearch = new HttpParams().set('school_id', schoolId).set('store_id', storeId);
  ...
  ngOnInit() {
    ...
    this.showStudentIds =
      canSchoolReadResource(this.session.g, CP_PRIVILEGES_MAP.services) && this.session.hasSSO;
  }
}
