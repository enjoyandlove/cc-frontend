...
@Component({
  selector: 'cp-events-excel-submit',
  templateUrl: './events-excel-submit.component.html',
  styleUrls: ['./events-excel-submit.component.scss']
})
export class EventsExcelSubmitComponent implements OnInit {
  events;
  mockDropdown;
  form: FormGroup;
  isFormReady = false;
