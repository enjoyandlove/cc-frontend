...
export class CPOnboardingComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.onBoardingSteps = [
      {
        id: 1,
        img: `${environment.root}public/png/onboarding/step_1.png`,
