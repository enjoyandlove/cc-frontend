...
export class CPMapsService {
  ...
  setMarker(map: google.maps.Map, position: google.maps.LatLngLiteral): google.maps.Marker {
  ...
  setCenter(map: google.maps.Map, position: google.maps.LatLngLiteral): google.maps.Map {
