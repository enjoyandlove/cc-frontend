...
@Component({
  selector: 'cp-qr-attendees-list',
  templateUrl: './qr-attendees-list.component.html',
  styleUrls: ['./qr-attendees-list.component.scss']
})
export class QrAttendeesListComponent extends BaseComponent implements OnInit {
