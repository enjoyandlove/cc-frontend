...
@Component({
  selector: 'cp-qr-attendees-action-box',
  templateUrl: './qr-attendees-action-box.component.html',
  styleUrls: ['./qr-attendees-action-box.component.scss']
})
export class QrAttendeesActionBoxComponent implements OnInit {
